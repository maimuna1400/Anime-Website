...
function fetchAnimeList() {
  const apiUrl = 'https://api.jikan.moe/v4/seasons/upcoming?sfw&limit=20';
        ...
        data.data.forEach(data => {
          ...
          <div class="card__inner">
            <div class="card__face">
                      <div class = "anime_img">
                      <a href = "${data.url}" class = "get-anime" target="_blank"><img src = "${data.images.jpg.large_image_url}" alt = "anime"></a>
                      </div>
